			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="create_account_area">
							<h2 class="caa_heading">New Registration, for <font color=red>Homemaker</font></h2>
							<div class="caa_form_area">
								<div class="caa_form_group">
									<div class="login_email">
									<form action=hsignup_action.php method="POST">
										<label>Name</label>
               ...
               <option value="<?php echo $fetch['district_id']?>"><?php echo $fetch['district_name']?>  <?php
						...
						?>
									...
									<div class="login_password">
										<label>Photo</label>
										<div class="input-area"><input type="file" name="photo"/></div>
									</div>
